...
#if defined(CONFIG_SYS_BOOT_FROM_SPI)		/* we are booting from SPI, so *DO* swap CSA and CSC with JE2 */
...
#define CONFIG_SYS_EMI_NAND_BASE	0xA6000000	/* CSC: NAND Flash, Physical 0x06000000 (8MiB) */
#define CONFIG_SYS_NAND_FLEX_CSn_MAP	{ 0 }		/* NAND is on Chip Select CSA */
#elif defined(CONFIG_SYS_BOOT_FROM_NAND)	/* we are booting from NAND, so *DO* swap CSA and CSC with JE2 */
...
#define CONFIG_SYS_EMI_NAND_BASE	0xA6000000	/* CSC: NAND Flash, Physical 0x06000000 (8MiB) */
#define CONFIG_SYS_NAND_FLEX_CSn_MAP	{ 2 }		/* NAND is on Chip Select CSC */
...
#define CONFIG_SYS_MONITOR_LEN		0x00060000	/* Reserve 256 KiB for Monitor */
...
#elif CONFIG_SYS_MONITOR_LEN == 0x00060000	/* 384 KiB */
#	define MONITOR_SECTORS	"1:0-5"		/* 6 sectors */
#else						/* unknown */
...
#define CONFIG_SYS_PROMPT		"PDK7105> "		/* Monitor Command Prompt	*/
#define CONFIG_SYS_PROMPT_HUSH_PS2	"> "
#define CONFIG_SYS_HZ			1000			/* HZ for timer ticks	*/
#define CONFIG_SYS_LOAD_ADDR		CONFIG_SYS_SDRAM_BASE	/* default load address		*/
#define CONFIG_BOOTDELAY		2			/* default delay before executing bootcmd */
...
#		define MTDPARTS_DEFAULT						\
		"mtdparts="	/* Omit NOR because it doesn't work*/		\
